...
a timer you set. A 30-minute floor-check mission pointing at Hakan (body: 'Are all agents making
progress? Re-engage anyone idle.') turns the orchestrator into a self-healing system: even if the floor
goes quiet, Hakan wakes up, reads the hive state, and re-engages stuck agents without you touching
anything.
