...
The Command Center — Hakan's control surface — got the biggest single overhaul of the release. It's now the
...
- **@albozes** — Hakan cancelling his own bypass-permissions prompt (#2).
