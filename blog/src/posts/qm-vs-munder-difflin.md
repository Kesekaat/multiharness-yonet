...
faq:
  ...
  - q: "Does qm have voice control, an IDE, or git visualization?"
    a: "Not as of this writing. qm's interfaces are Slack and a web UI. Munder Difflin ships realtime voice orchestration (a talking Hakan with live floor context), a built-in Monaco IDE with commit history, branch compare and side-by-side diffs, markdown previews, real watchable terminals, and auto-update."
...
- **Voice orchestration.** Flip on talk mode and Hakan greets you already knowing every
