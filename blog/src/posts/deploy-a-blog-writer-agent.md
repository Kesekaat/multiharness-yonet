...
<strong>isolated worktree</strong> from a topic brief + a house-style reference; <strong>Hakan</strong>
...
The writer **never commits**. It writes a plain file; **Hakan** owns every commit. This is
