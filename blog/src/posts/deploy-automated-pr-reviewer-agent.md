...
faq:
  - q: "How do you deploy an automated PR reviewer in Munder Difflin?"
    a: "You brief Hakan, the orchestrator, in plain English: give him a review objective, point him at the repo and its open PRs/issues, and ask him to post reviews back and escalate anything serious. He spins up a dedicated PR Reviewer agent, runs the first pass, and registers a recurring mission in the Triggers tab so new PRs get reviewed on a cadence. No YAML, no webhook, no per-seat SaaS subscription."
...
You don't configure this. You brief it. Open Munder Difflin, select Hakan, and describe the outcome the way you'd brief a coworker:
...
3. Brief Hakan with the prompt above, swapping in your repo and your escalation bar.
