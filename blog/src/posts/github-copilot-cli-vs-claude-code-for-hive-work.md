...
- **Orchestrator eligibility.** Because the process is long-lived and observable, Claude Code can be the [BOSS orchestrator](/blog/how-the-boss-orchestrator-works/) itself — the always-on supervisor that adjudicates traffic and routes tasks.
