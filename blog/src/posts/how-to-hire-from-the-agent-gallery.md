...
Click spawn. The agent appears at a desk, joins the hive with its own mailbox and long-term memory, and is immediately routable: assign it kanban tasks, or just tell the BOSS orchestrator what you need and let [Michael route the work](/blog/how-the-boss-orchestrator-works/).
