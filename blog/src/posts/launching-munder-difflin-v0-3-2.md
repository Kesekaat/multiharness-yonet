...
description: "Munder Difflin v0.3.2 adds Realtime Michael — a low-latency voice channel to the BOSS orchestrator. Talk to Michael and he listens, answers, and acts: reading the hive and, behind spoken echo-back confirmation, dispatching, spawning, and steering the floor in real time."
date: 2026-06-27
category: story
categoryLabel: Story
type: Non-technical
...
> Michael repeats back exactly what he's about to do, and waits for a **distinct confirm token** — never a bare "yes". and some things he just won't do: **killing the BOSS agent**, or **targeting every agent at once**, are refused outright.
