...
// Integrations configuration UI — Settings → Integrations. Conformed to Caner's
// spec v1 (hive/docs/integrations-spec.md) and styled to Selin's mockup
...
//
// v1 worker model (Caner §4): the broker grants EVERY enabled integration to ALL
...
// extension; this reflection updates when Caner confirms that model.
...
// UI-only brand glyphs (Caner's templates carry no glyph). Falls back to label initials.
...
/** Is an integration actually usable by workers? (Caner §6 gate.) */
