...
/** A preset that seeds an IntegrationRecord. Batur extends the catalog by appending
...
/** v1 reference templates — the two end-to-end references. Batur appends more here. */
